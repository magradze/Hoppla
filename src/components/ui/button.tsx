...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 alk-sanet",
    {
        variants: {
            variant: {
                default:
                ...
                google:
                    "bg-[#f2f2f2] text-[#1f1f1f] shadow-sm hover:bg-[#f0f0f0]",
                facebook:
