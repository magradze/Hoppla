...
const navigation = {
    ...
    legal: [
        {name: 'პოპულარული მარშრუტები', href: '#'},
        {name: 'პოპულარული ადგილები', href: '#'},
        {name: 'როგორ მუშაობს', href: '#'},
        {name: 'ვინ ვართ ჩვენ', href: '#'},
        {name: 'დახმარების ცენტრი', href: '#'},
        {name: 'კარიერა', href: '#'},
    ],
    social: [
        {
        ...
        <footer className="bg-white" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-24">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        ...
                        <p className="text-sm leading-6 text-gray-600">
                            გაემგზავრე HOPPLA-ს დახმარებით სასურველ ადგილას. მიიღე უახლესი ინფორმაცია და დაჯავშნე ბილეთი
                            სმარტფონით.
                        </p>
                ...
                <div className="mt-16 border-t border-gray-900/10 pt-8">
                    <p className="text-xs leading-5 text-gray-500">&copy; {new Date().getFullYear()} Hoopla</p>
                </div>
            </div>
        </footer>
    );
