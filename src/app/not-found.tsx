...
import {BookOpenIcon, CarIcon, ChevronRightIcon, RssIcon} from "lucide-react";

const links = [
    {
        name: 'დოკუმენტაცია',
        href: '#',
        description: 'სწავლეთ საიტის სწორად გამოყენება.',
        icon: BookOpenIcon,
    },
    {name: 'მარშრუტები', href: '#', description: 'იპოვეთ სასურველი მარშრუტი.', icon: CarIcon},
    {name: 'ბლოგი', href: '#', description: 'წაიკითხეთ სიახლეები ჩვენს შესახებ.', icon: RssIcon},
]
const social = [
    {
        name: 'X',
            ...
            <main className=" page-wrapper px-6 pb-16 pt-10 sm:pb-24 lg:px-8 fira-go">
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-6 sm:text-lg sm:leading-8">
                        უკაცრავად, ჩვენ ვერ ვიპოვეთ გვერდი, რომელსაც ეძებთ.
                    </p>
                </div>
